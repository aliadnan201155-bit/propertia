# 🏠 Propertia - Complete Project Setup & Running Guide
...
Propertia is a modern, full-stack real estate platform consisting of three interconnected applications:
...
```
Propertia Platform Architecture
├── Frontend (React + Vite) 🌐
│   ├── Port: 5173
